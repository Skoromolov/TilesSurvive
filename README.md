...
`mail.png`, `conferm_button.png`, `reconnect.png`, `reconnectRepeat.png`, `souz.png`, `news.png`, `village.png`, `wild_earth.png`, `close.png`, `back.png`, `help_hands.png`, `events.png`, `info.png`.
...
- Выполняет процесс:
  1. Открывает события (`events.png`) и свайпает влево по верхнему меню событий, затем вправо для поиска события золотодобычи (`rudnik.png`).
