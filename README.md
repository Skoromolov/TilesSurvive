...
`mail.png`, `conferm_button.png`, `reconnect.png`, `reconnectRepeat.png`, `souz.png`, `news.png`, `village.png`, `wild_earth.png`, `close.png`, `back.png`, `help_hands.png`, `events.png`, `info.png`, `calendar.png`, `calendar_opened.png`, `event_gold.png`.
...
- Выполняет процесс:
  1. Открывает события (`events.png`), открывает календарь (`calendar.png`) и свайпает влево по меню, затем вправо для поиска события золотодобычи (`event_gold.png`).
...
while (event_gold.png?) is (нет)
  :Свайп влево по верхнему меню событий;
endwhile (да)
