...
GOLD_ACTION_DELAY = 0.05      # Короткая пауза после клика внутри gold-процесса (сек)
...
ADVENTURE_PAGE_IMG = FOLDER + FOLDER_COMMON + 'adventure_page.png'
BAGGAGE_POPUP_IMG = FOLDER + FOLDER_COMMON + 'baggage_popup.png'
