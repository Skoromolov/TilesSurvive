...
GOLD_LEVEL_CONFIDENCE_THRESHOLD = 0.90  # ПОРОГ = 0.90  # Порог для current_lvl_X (было 0.95 — слишком высоко)
...
GOLD_ACTION_DELAY = 0.3      # Короткая пауза после клика внутри gold-процесса (сек)
